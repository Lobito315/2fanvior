      ...
      <main className="relative z-10 w-full max-w-[480px] space-y-8">
        ...
        <div className="glass-card p-10 rounded-lg shadow-2xl space-y-8 border border-outline-variant/10">
          ...
          <div className="grid grid-cols-1 gap-4">
            <button className="flex items-center justify-center gap-3 w-full h-14 rounded-full bg-surface-container-lowest text-on-surface font-medium hover:bg-surface-bright transition-all duration-300 border border-outline/20">
